...
#pragma config(Motor,  port2,           frDrive,       tmotorVex393HighSpeed_MC29, openLoop, reversed)
#pragma config(Motor,  port3,           brDrive,       tmotorVex393HighSpeed_MC29, openLoop, reversed)
#pragma config(Motor,  port4,           ryLift,        tmotorVex393HighSpeed_MC29, openLoop)
...
#pragma config(Motor,  port7,           lyLift,        tmotorVex393HighSpeed_MC29, openLoop, reversed)
#pragma config(Motor,  port8,           blDrive,       tmotorVex393HighSpeed_MC29, openLoop)
#pragma config(Motor,  port9,           flDrive,       tmotorVex393HighSpeed_MC29, openLoop)
...
#define setRDrive(pwr) motor[frDrive] = motor[brDrive] = pwr
#define setLDrive(pwr) motor[flDrive] = motor[blDrive] = pwr
